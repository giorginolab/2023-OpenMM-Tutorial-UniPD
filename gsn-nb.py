...
PDBFile.writeFile(modeller.topology, modeller.positions, open("6H1F-modelled.pdb","w"),
                  keepIds=True)
...
simulation.reporters.append(StateDataReporter(stdout, 100, step=True, time=True, potentialEnergy=True,
